...
public class OpenCLDeviceMetadata {
    ...
    /** CUDA device ordinal. The legacy pointer fields are retained for source compatibility. */
    public final int cudaDeviceIndex;
    ...
    OpenCLDeviceMetadata(long platformPtr, long devicePtr, CLCapabilities platformCaps, CLCapabilities deviceCaps, UUID deviceUUID, UUID driverUUID) {
        ...
        this.cudaDeviceIndex = (int) devicePtr;
        this.deviceName = "CUDA device " + this.cudaDeviceIndex;
    }

    public OpenCLDeviceMetadata(int cudaDeviceIndex, String deviceName, UUID deviceUUID, UUID driverUUID) {
        this.platformPtr = 0L;
        this.devicePtr = cudaDeviceIndex;
        this.platformCaps = null;
        this.deviceCaps = null;
        this.deviceUUID = Objects.requireNonNull(deviceUUID);
        this.driverUUID = Objects.requireNonNull(driverUUID);
        this.supportsNonUniformWorkgroups = true;
        this.isIntelNeoRuntime = false;
